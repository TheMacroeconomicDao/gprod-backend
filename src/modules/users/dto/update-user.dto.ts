...
import { IsOptional, IsArray, ArrayNotEmpty, ArrayUnique, IsIn } from 'class-validator';
...
export class UpdateUserDto extends PartialType(CreateUserDto) {
  ...
  @ApiProperty({ description: 'Новые роли', required: false, example: ['user', 'admin'], isArray: true, enum: UserRole })
  @IsOptional()
  @IsArray()
  @ArrayNotEmpty()
  @ArrayUnique()
