...
export class ProjectsController {
  ...
  async remove(@Param('id') id: string, @Req() req: any) {
    ...
    console.log(
      '[ProjectsController.remove] project:',
    ...
    console.log(
      '[ProjectsController.remove] userIdFromToken:',
      userIdFromToken,
    );
    console.log(
      '[ProjectsController.remove] project.ownerId:',
      project.ownerId,
    );
    console.log(
      '[ProjectsController.remove] типы: userIdFromToken:',
      typeof userIdFromToken,
      'project.ownerId:',
      typeof project.ownerId,
    );
    console.log(
      '[ProjectsController.remove] сравнение:',
      project.ownerId === userIdFromToken,
    );
    console.log(
      '[ProjectsController.remove] числовое сравнение:',
